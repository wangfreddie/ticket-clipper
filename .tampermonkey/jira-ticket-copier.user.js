// ==UserScript==
// @name         Jira Ticket ID Copier
// @namespace    http://tampermonkey.net/
// @version      1.1
// @description  Quickly copy Jira ticket IDs to clipboard with keyboard shortcuts
// @author       Frederick Wang
// @match        *://*.atlassian.net/*
// @match        https://procoretech.atlassian.net/*
// @grant        none
// @run-at       document-end
// ==/UserScript==
...
(function () {
    ...
    style.textContent = `
        ...
        .jira-ticket-notification.success {
            background-color: #4CAF50;
        }

        .jira-ticket-notification.error {
